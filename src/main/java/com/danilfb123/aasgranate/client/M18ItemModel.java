...
public class M18ItemModel extends GeoModel<M18Item> {
    @Override
    public ResourceLocation getModelResource(M18Item object) {
        return new ResourceLocation(AasGranate.MOD_ID, "geo/m_18.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(M18Item object) {
        return new ResourceLocation(AasGranate.MOD_ID, "textures/item/m_18.png");
    }

    @Override
    public ResourceLocation getAnimationResource(M18Item animatable) {
