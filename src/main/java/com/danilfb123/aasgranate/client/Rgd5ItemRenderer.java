...
public class Rgd5ItemRenderer extends GeoItemRenderer<Rgd5Item> {
    public Rgd5ItemRenderer() {
        super(new Rgd5ItemModel());
    }
    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext transformType, PoseStack poseStack,
        ...
        if (transformType == ItemDisplayContext.GUI
            ...
            BakedModel flatModel = mc.getModelManager().getModel(ClientModEvents.RGD_5_FLAT_MODEL);
