...
public class M18Item extends Item implements GeoItem {
    ...
    public M18Item(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        level.playSound(null, player.getX(), player.getY(), player.getZ(),
                ModSounds.M18_PIN_PULL.get(), SoundSource.PLAYERS, 1.0F, 1.0F);
    ...
    public void releaseUsing(ItemStack stack, Level level, LivingEntity entityLiving, int timeLeft) {
        ...
        level.playSound(null, player.getX(), player.getY(), player.getZ(),
                ModSounds.M18_THROW.get(), SoundSource.PLAYERS, 1.0F, 1.0F);

        if (!level.isClientSide) {
            M18Entity projectile = new M18Entity(level, player);
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (this.renderer == null) {
                    this.renderer = new com.danilfb123.aasgranate.client.M18ItemRenderer();
                }
    ...
    private PlayState predicate(AnimationState<M18Item> event) {
